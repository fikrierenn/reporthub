...
## 0. Inline Style YASAĞI

`style="..."` HTML attribute sıfır toleranslı yasaktır. **Tam kural ve istisnalar:** [`.claude/rules/inline-style-guard.md`](inline-style-guard.md). Yeni view yazmadan önce o dosyayı oku.
